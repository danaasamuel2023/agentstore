...
export const SAVEABLE_CUSTOMIZATION_KEYS = [
  ...
  'showPrices',
  'promoEnabled',
  // Newer than the rest: these two require the matching additive fields on
  // AgentStore.customization to be live on the API box. Until that deploy
  // lands, Mongoose strict mode drops them and the save reports it — see the
  // `dropped` return from saveStoreSettings in lib/ownerSession.js.
  'heroHeadline',
  'heroSubheadline',
];
